...
- AniShelf does not require account registration.
...
- AniShelf does not intentionally collect analytics or crash-reporting data.

## Information AniShelf Handles

AniShelf may handle the following categories of information:

### 1. Library Data You Create
...
device so the app can authenticate requests to TMDb.

### 3. Search and Metadata Requests
...
### 5. Backup, Import, Export, and Sharing Data

If you use backup, restore, export, import, or sharing features, AniShelf may
create files containing your library data and app preferences. Those files are
created only when you initiate those actions.
...
If you use AniShelf, network requests to TMDb or related content providers may
be processed in countries other than your own, subject to those providers'
