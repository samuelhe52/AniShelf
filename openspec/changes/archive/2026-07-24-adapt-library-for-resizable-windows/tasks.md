...
- [x] 2.3 Consolidate mutually exclusive library workflow sheets into one route-driven host while keeping stable detail sheet and inspector hosts
...
- [x] 3.3 Use a genuine detail sheet for current iPhone and other compact environments
- [x] 3.4 Attach stable dismissible sheet and inspector hosts without root geometry measurement
- [x] 3.5 Update an open inspector when the focused entry changes and reclaim the complete library canvas when it closes
- [x] 3.6 Preserve the detail session, scroll state, and unsaved editing state through explicit host migration
...
- [x] 9.2 Add a library-root detail-host policy that maps every mode to a sheet in compact horizontal size class or an inspector in regular horizontal size class, without root geometry, mode, or idiom checks
