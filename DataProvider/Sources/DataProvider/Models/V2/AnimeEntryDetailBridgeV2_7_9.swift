...
extension SchemaV2_7_9.AnimeEntryDetail {
    public convenience init(from dto: AnimeEntryDetailDTO) {
        self.init(
            ...
            seasons: dto.seasons.map(SchemaV2_7_9.AnimeEntrySeasonSummary.init(from:)),
    ...
    public convenience init(fromLegacy payload: LegacyAnimeEntryDetailPayload) {
        self.init(
            ...
            staff: [],
            seasons: payload.seasons.map(SchemaV2_7_9.AnimeEntrySeasonSummary.init(fromLegacy:)),
    ...
    private static func makeCharacters(
        ...
        dtos.enumerated().map {
            SchemaV2_7_9.AnimeEntryCharacter(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeCharacters(
        ...
        payloads.enumerated().map {
            SchemaV2_7_9.AnimeEntryCharacter(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeStaff(
        ...
        dtos.enumerated().map {
            SchemaV2_7_9.AnimeEntryStaff(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeEpisodes(
        ...
        dtos.enumerated().map {
            SchemaV2_7_9.AnimeEntryEpisodeSummary(from: $0.element, displayOrder: $0.offset)
        }
    }
    ...
    private static func makeEpisodes(
        ...
        payloads.enumerated().map {
            SchemaV2_7_9.AnimeEntryEpisodeSummary(fromLegacy: $0.element, displayOrder: $0.offset)
        }
    }
}
