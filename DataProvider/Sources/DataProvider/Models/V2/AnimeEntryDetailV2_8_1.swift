...
extension SchemaV2_8_1 {
    ...
    public final class AnimeEntryDetail {
        ...
        @Relationship(deleteRule: .cascade, inverse: \AnimeEntryProductionCompany.detail)
        public var productionCompanies: [AnimeEntryProductionCompany] = []
        ...
        public init(
            ...
            seasonCount: Int? = nil,
            productionCompanies: [AnimeEntryProductionCompany] = [],
