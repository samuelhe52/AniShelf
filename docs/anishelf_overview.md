...
- 是否会上架 App Store？**已经环大陆上架。[App Store 链接](https://apps.apple.com/us/app/anishelf/id6759359144)。注意目前国区因为备案原因无法上架。大多数情况下，新功能仍然将先在 TestFlight 发布，后续再推送到 App Store。**
