...
enum EntryDetailL10n {
    ...
    static let airingReminders: LocalizedStringResource = "Airing Reminders"
    ...
    static let enable: LocalizedStringResource = "Enable"
    static let disable: LocalizedStringResource = "Disable"
