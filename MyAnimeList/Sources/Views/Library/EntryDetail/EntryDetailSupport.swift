...
enum EntryDetailL10n {
    ...
    static let notSubscribed: LocalizedStringResource = "Not Subscribed"
    static let nextNotification: LocalizedStringResource = "Next Notification"
    static let noUpcomingNotification: LocalizedStringResource = "No Upcoming Notification"
