...
struct LibraryCloudSyncPreferencesTests {
    ...
    @Test @MainActor func testCloudSyncedPreferenceAllowlistMatchesApprovedKeys() {
        ...
        #expect(!String.cloudSyncedPreferenceKeys.contains(.libraryPresentedDetailEntryIdentity))
    ...
    @Test @MainActor func testCloudSyncedSettingsSnapshotExportsOnlyAllowlistedKeys() {
        ...
        defaults.set("series:42", forKey: .libraryPresentedDetailEntryIdentity)
        ...
        #expect(snapshot.payload[.libraryPresentedDetailEntryIdentity] == nil)
